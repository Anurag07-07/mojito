...
const About = () => {
  ...
  useGSAP(()=>{
    ...
    },'-=0.5') //This is use to start animation half  a second early before prev one ends
  })
      ...
      <div className=' mb-16 md:px-0 px-5'>
        <div className='content'>
          <div className=' md:col-span-8'>
            ...
            <h2>Where every detail matters <span className=' text-white'> - </span>ffrom muddle to garnish</h2>
            </div>
